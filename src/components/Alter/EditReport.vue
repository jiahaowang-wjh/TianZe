...
<template>
    <div class='add-report'>
        <div class='add-report-title'>
            ...
            <span class='add-report-title-go2'>录入信息修改</span>
        </div>
                ...
                <el-collapse>
                    ...
                    <el-collapse-item title="债事人基本信息登记表" name="1">
                        ...
                        <div class='add-report-container-form-person-button'>
                            <button  @click='SendReporterData' :disabled='HasSubmitDebt'>修改提交</button>
                        </div>
                    </el-collapse-item>
                    <!-- 相对人基本信息表 -->
                    <el-collapse-item title="相对人基本信息表" name="2">
                        <div class='add-report-container-relative'>
                            ...
                            <div class='add-report-container-form-person-button-submit'>
...
export default {
    ...
    methods: {
        ...
        async ShowSumitToCompany () {
            const formData = new FormData()
            const tel = this.RelativePhone
            formData.append('tel', tel)
            formData.append('checkNo', this.RelativePhoneCheck.CheckNo)
            const { data: result } = await this.$http({
                method: 'post',
                url: '/api/api/smsSend/checkNO',
                data: formData,
