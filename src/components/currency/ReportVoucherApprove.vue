...
export default {
    ...
    methods: {
        async InitData () {
            const payId = this.$store.state.payId
            ...
            console.log('reportId', this.$store.state.reportId)
            console.log('payId', this.$store.state.payId)
        ...
        async PassPayment () {
            ...
            await this.UpdateStatus('5').then(result => {
                ...
                console.log(this.$store.state.reportId)
        ...
        async UpdateStatus (status) {
            const formData = new FormData()
            this.SubmitData.reportId = this.$store.state.reportId
