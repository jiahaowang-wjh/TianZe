...
<template>
  <div class='pay-detail'>
      ...
      <div class='pay-detail-list'>
        <div class='pay-detail-list-select'>
        ...
        <div class='pay-detail-list-content'>
            ...
            <template>
                ...
                <div class='pay-detail-list-content-tab'>
                    <div class='pay-detail-list-content-tab-item' v-for='(item,index) in PaymentMsg' :key='index'>
                        <span>{{index+1}}</span>
                        ...
                        <span :class="[item.status === '2' ? ('pass') : item.status === '1'? 'unpass': 'hassubmit']">{{item.status === '0'?('未审核'):item.status === '1'?('审核未通过'):item.status === '2'?('审核通过'):item.status === '3'?('财务未审核'):('财务审核') }}</span>
                    </div>
                </div>
            </template>
        </div>
