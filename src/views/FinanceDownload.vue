...
<template>
  <div class="download">
    <div class="download-title">辅助财务信息</div>
    <div class="download-list">
      <div class="download-list-search">
        ...
        <el-date-picker
          align="left"
          type="date"
          placeholder="请输入想查的日期"
          :picker-options="pickerOptions"
          value-format="yyyy-MM-dd"
          v-model="SearchForm.time"
        ></el-date-picker>
        <button type="button" @click="SearchData">搜索</button>
        <a :href="`/wordConversion/downSelectDow`" target="_blank">
      ...
      <div class="download-list-content">
        ...
        <div class="download-list-content-tab">
          <div
            class="download-list-content-tab-item"
            v-for="(item, index) in downloadMsg"
            :key="index"
          >
            <span>{{ index + 1 }}</span>
