            ...
            <template v-if="ReportMsg.reportPropert === '1'">
              ...
              <div class="report-approve-container-form-person-upload-idcard">
                ...
                <input
                  ...
                  class="report-approve-container-form-person-upload-idcard-just"
                  value="点击上传"
                />
                <button>点击上传</button>
                <img
                ...
                <input
                  ...
                  class="report-approve-container-form-person-upload-idcard-back"
                  value="点击上传"
                />
                <button>点击上传</button>
              </div>
              ...
              <div class="report-approve-container-form-person-update-imgs">
                ...
                <input
                  ...
                  class="report-approve-container-form-person-update-imgs-form"
                  value="点击上传"
                />
                <button>点击上传</button>
              </div>
            ...
            <template v-else-if="ReportMsg.reportPropert === '2'">
              ...
              <div class="report-approve-container-form-business-upload-idcard">
                ...
                <input
                  ...
                  class="report-approve-container-form-business-upload-idcard-just"
                  value="点击上传"
                />
                <button>点击上传</button>
                <img
                ...
                <input
                  ...
                  class="report-approve-container-form-business-upload-idcard-back"
                  value="点击上传"
                />
                <button>点击上传</button>
              </div>
              ...
              <div class="report-approve-container-form-business-update-imgs">
                ...
                <input
                  ...
                  class="report-approve-container-form-business-update-imgs-form"
                  value="点击上传"
                />
                <button>点击上传</button>
              </div>
            ...
            <template v-else>
              ...
              <div class="report-approve-container-form-bank-update-imgs">
                ...
                <input
                  ...
                  class="report-approve-container-form-bank-update-imgs-form"
                  value="点击上传"
                />
                <button>点击上传</button>
              </div>
              ...
              <template v-if="RelativeMsg.reportPropert === '1'">
                ...
                <div class="report-approve-container-relative-form-person-upload-idcard">
                  ...
                  <input
                    ...
                    class="report-approve-container-relative-form-person-upload-idcard-just"
                    value="点击上传"
                  />
                  <button>点击上传</button>
                  <img
                  ...
                  <input
                    ...
                    class="report-approve-container-relative-form-person-upload-idcard-back"
                    value="点击上传"
                  />
                  <button>点击上传</button>
                </div>
              ...
              <template v-else-if="RelativeMsg.reportPropert === '2'">
                ...
                <div class="report-approve-container-relative-form-business-upload-idcard">
                  ...
                  <input
                    ...
                    class="report-approve-container-relative-form-business-upload-idcard-just"
                    value="点击上传"
                  />
                  <button>点击上传</button>
                  <img
                  ...
                  <input
                    ...
                    class="report-approve-container-relative-form-business-upload-idcard-back"
                    value="点击上传"
                  />
                  <button>点击上传</button>
                </div>
