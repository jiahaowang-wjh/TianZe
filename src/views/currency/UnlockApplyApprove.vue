        ...
        <el-collapse>
          ...
          <el-collapse-item title="关系绑定" name="1">
            ...
            <div class="unlock-apply-container-form-select">
              ...
              <el-select v-model="MediaIndex" @change="GetMediaMsg">
                <el-option
                  :label="`${item.civilno} 债事人: ${item.personName}`"
                  :value="item.value"
            ...
            <div class="unlock-apply-container-form-defuse-2">
              ...
              <div>
                本次申请转让债权金额（大写）：
                <input type="text" :value="SubmitData.amountThis|Uppercase" />
              </div>
              <div></div>
            </div>
          </el-collapse-item>
          ...
          <el-collapse-item title="咨询服务协议" name="3">
            ...
            <div class="unlock-apply-container-form-serve-agreement-service-charge-1">
              ...
              <div>
                本次策划方案服务费（大写）：
                <input type="text" :value="SubmitData.servicePrincipal | Uppercase" />
              </div>
            </div>
            <h3>其他约定事项</h3>
...
export default {
  ...
  methods: {
    ...
    async InitData() {
      ...
      formDatas.append('reportId', reportId)
      const { data: results } = await this.$http({
        method: 'post',
      ...
      CivilMsgformData.append('civilId', result.data.civilId)
    ...
    async SubmitMessage() {
      ...
      if (result.resultCode === '200') {
        ...
        if (
          StageUpdateResult.resultCode === '200' &&
          StatusUpdateResult.resultCode === '200'
        ) {
