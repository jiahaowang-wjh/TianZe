...
<template>
  <div class="password">
    ...
    <div class="password-content">
      ...
      <div class="password-content-label">原密码:</div>
      <div>
        <input type="text" v-model="PasswordList.outPwd" />
      </div>
      <div class="password-content-label">新密码:</div>
      <div>
        <input type="text" v-model="PasswordList.newPwdA" />
      </div>
      <div class="password-content-label">重复新密码:</div>
      <div>
        <input type="text" v-model="PasswordList.newPwdB" />
      </div>
      <button type="button" @click="ChangePassword">确认</button>
    </div>
  </div>
</template>
