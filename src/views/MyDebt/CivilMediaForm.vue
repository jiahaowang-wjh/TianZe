        ...
        <el-collapse>
          ...
          <el-collapse-item title="调解资料" name="1">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  ...
                  <el-form-item label>
                    <el-input
                      :disabled="true"
                      :value="MediaUserMsg.debtLegalName"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  ...
                  <el-form-item label>
                    <el-input
                      :disabled="true"
                      :value="MediaUserMsg.debtIdCardCode"
                    ></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                <el-col :span="8">
                  ...
                  <el-form-item label>
                    <el-input
                      :disabled="true"
                      :value="MediaUserMsg.personalName"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                <el-col :span="8">
                  ...
                  <el-form-item label>
                    <el-input
                      :disabled="true"
                      :value="MediaUserMsg.personalAdd"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  ...
                  <el-form-item label>
                    <el-input
                      :disabled="true"
                      :value="MediaUserMsg.personalPhone"
                    ></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            ...
            <div class="civil-media-container-form-new-guarantor">
              <button type="button" @click="AddGuarantee">新增担保人</button>
            </div>
            <!-- 表单2 担保人表单 -->
            ...
            <div class="civil-media-container-form-table-2">
              <div
                ...
                v-for="(item, index) in GuaranteesList"
                :key="index"
              >
                <span>{{ index + 1 }}</span>
                ...
                <span>
                  <button type="button" @click="DeleteGuaranteesList(index)">
                    删除
                  </button>
                </span>
              </div>
            ...
            <div>
              ...
              <label for="6">
                <input
                  ...
                  id="6"
                  value="1"
                  v-model="SubmitData.guaranteeMeth"
                />保证
              </label>
              <label for="7">
                <input
            ...
            <div class="civil-media-container-form-table-3">
              <div
                class="civil-media-container-form-table-3-item"
            ...
            <div class="civil-media-container-form-update-imgs">
              ...
              <input
                ...
                ref="Voucher"
                class="civil-media-container-form-update-imgs-form"
                value="点击上传"
              />
              <button>点击上传</button>
            </div>
    ...
    <div class="civil-media-add-mediator-pop" v-if="IsSelect">
      <div class="civil-media-add-mediator-pop-box">
        <div class="civil-media-add-mediator-pop-box-header">
          <span>新增调解员</span>
          <img
            src="@imgs/other/error@2x.png"
            alt=""
            @click="CloseAddConciliator"
          />
        </div>
        <div class="civil-media-add-mediator-pop-box-body">
          <form>
            <div
              class="civil-media-add-mediator-pop-box-body-item"
              v-for="(item, index) in MediatorList"
              :key="index"
            >
              <input
                type="radio"
        ...
        <div class="civil-media-add-mediator-pop-box-footer">
          <button type="button" @click="CloseAddConciliator">取消</button>
          <button type="button" @click="SelectMediator">确认</button>
        </div>
      </div>
    </div>
    <!-- 查看调解员详细信息 -->
    <div
      class="civil-media-add-mediator-content-pop"
      v-if="IsAddConciliatorContent"
    >
      <div class="civil-media-add-mediator-content-pop-box">
        ...
        <div class="civil-media-add-mediator-content-pop-box-body">
          ...
          <div class="civil-media-add-mediator-content-pop-box-body-tabel">
            <div
              class="civil-media-add-mediator-content-pop-box-body-tabel-item"
              v-for="(item, index) in MediatorListDetailContent"
              :key="index"
            >
        ...
        <div class="civil-media-add-mediator-content-pop-box-footer">
          <button type="button" @click="CloseAddGuaranteeList">取消</button>
          <button type="button" @click="AddMediatorContent">添加调解员</button>
        </div>
      </div>
    </div>
    <!-- 新增担保人 -->
    <div class="civil-media-add-guarantor-pop" v-if="IsAddConciliator">
      <div class="civil-media-add-guarantor-pop-box">
        ...
        <div class="civil-media-add-guarantor-pop-box-footer">
          <button type="button" @click="CloseAddGuarantee">取消</button>
          <button type="button" @click="AddGuaranteeContent">添加担保人</button>
        </div>
      </div>
    </div>
    <!-- 选择相对人 -->
        ...
        <div class="civil-media-pop-relative-box-body">
          ...
          <el-select v-model="relativePerId">
            <el-option
              ...
              :value="item.relativePerId"
            ></el-option>
          </el-select>
        </div>
        <div class="civil-media-pop-relative-box-footer">
          <button type="button" @click="CloseRelativeList">取消</button>
          <button type="button" @click="SelectRelative">确认</button>
        </div>
      </div>
    </div>
  </div>
