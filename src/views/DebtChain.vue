...
<template>
    <div class='debt-chain'>
        <div class='debt-chain-title'>
            债事链
        </div>
        <div class='debt-chain-search'>
            <span>请输入债权人姓名</span>
            <input type="text" placeholder="请输入查询人姓名" class='debt-chain-search-form' v-model='PersonIdCard'>
            <button class='debt-chain-search-button' @click='GetDebtChain'>搜索</button>
        </div>
        <template>
        </template>
            ...
            <template v-else>
                <div class='debt-chain-content-data' >
                    <div class='debt-chain-content-data-container' >
                        <echarts :optionData='RelationshipOption' :IsInitData='true'></echarts>
                    </div>
                </div>
            </template>
        </div>
