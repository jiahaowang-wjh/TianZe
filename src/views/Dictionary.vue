...
<template>
  <div class="dictionary">
    <div class="dictionary-title">字典管理</div>
    <div class="dictionary-list">
      <div class="dictionary-list-button">
        <el-button class="dictionary-list-button-more" @click="SelectMore"
          >选择多项</el-button
        >
        <el-button class="dictionary-list-button-add" @click="AddDictionary"
          >新增字典</el-button
        >
        <el-button class="dictionary-list-button-del" @click="DeleteData"
          >删除</el-button
        >
      </div>
      <div class="dictionary-list-content">
        ...
        <template v-if="isNormal">
          ...
          <div class="dictionary-list-content-tab">
            <div
              class="dictionary-list-content-tab-item"
              v-for="(item, index) in DictionaryMsg"
              :key="index"
            >
              <span>{{ index + 1 }}</span>
              ...
              <span>{{ item.note }}</span>
              <span>
                <button type="button" @click="AlterDictionary(index)">
                  编辑
                </button>
              </span>
            </div>
      ...
      <div class="dictionary-add-dictionary-box">
        ...
        <div class="dictionary-add-dictionary-box-body">
          <div>
            ...
            <el-select v-model="AddDictionaryMsg.dictionType">
              <el-option
                :value="item"
                :label="item"
                v-for="(item, index) in DiractionType"
                :key="index"
              ></el-option>
            </el-select>
          </div>
          <div>
            字典编码：<input
              type="text"
              v-model="AddDictionaryMsg.dictionCode"
            />
          </div>
          <div>
          ...
          <div>
            字典显示：<input
              type="text"
              v-model="AddDictionaryMsg.dictionDis"
            />
          </div>
          <div>
          ...
          <div>
            字典备注：<textarea
              cols="30"
              rows="10"
              v-model="AddDictionaryMsg.note"
            ></textarea>
          </div>
        </div>
        <div class="dictionary-add-dictionary-box-footer">
          <button type="button" @click="CloseDictionary">取消</button>
          <button type="button" @click="SubmitNew">确认</button>
        </div>
      </div>
    </div>
    <!-- 是否显示添加页面 -->
      ...
      <div class="dictionary-add-dictionary-box">
        ...
        <div class="dictionary-add-dictionary-box-body">
          ...
          <div>
            字典编码：<input
              type="text"
              v-model="AlterDictionaryMsg.dictionCode"
            />
          </div>
          <div>
            字典编号：<input
              type="text"
              v-model="AlterDictionaryMsg.dictionNo"
            />
          </div>
          <div>
            字典显示：<input
              type="text"
              v-model="AlterDictionaryMsg.dictionDis"
            />
          </div>
          <div>
          ...
          <div>
            字典备注：<textarea
              cols="30"
              rows="10"
              v-model="AlterDictionaryMsg.note"
            ></textarea>
          </div>
        </div>
        <div class="dictionary-add-dictionary-box-footer">
          <button type="button" @click="CloseEdit">取消</button>
          <button type="button" @click="SubmitAlterDictionary">确认</button>
        </div>
      </div>
    </div>
  </div>
