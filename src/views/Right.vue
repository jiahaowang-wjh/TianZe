  ...
  <div class="right">
    ...
    <div class="right-list">
      <div class="right-list-button">
        <el-button class="right-list-button-add" @click="OpenAdd"
          >新增权限</el-button
        >
      </div>
      <div class="right-list-content">
        ...
        <template v-if="isNormal">
          ...
          <div class="right-list-content-tab">
            <div
              class="right-list-content-tab-item"
              v-for="(item, index) in RightMsg"
              :key="index"
            >
              <span>{{ index + 1 }}</span>
              ...
              <span>
                ...
                <button type="button" @click="DelRight(index)">删除</button>
              </span>
            </div>
          </div>
        </template>
    ...
    <div class="right-add" v-if="IsAddRight">
      <div class="right-add-box">
        ...
        <div class="right-add-box-body">
          ...
          <div>备注：<input type="text" v-model="AddRightMsg.note" /></div>
        </div>
        <div class="right-add-box-footer">
          <button type="button" @click="CloseAdd">取消</button>
          <button type="button" @click="SubmitAddRight">确认</button>
        </div>
      </div>
    </div>
    <!-- 修改页面 -->
    <div class="right-add" v-if="IsEditRight">
      <div class="right-add-box">
        ...
        <div class="right-add-box-body">
          ...
          <div>备注：<input type="text" v-model="EditRightMsg.note" /></div>
        </div>
        <div class="right-add-box-footer">
          <button type="button" @click="CloseEdit">取消</button>
          <button type="button" @click="SubmitEditRight">确认</button>
        </div>
      </div>
    </div>
  </div>
