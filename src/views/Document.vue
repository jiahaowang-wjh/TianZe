    ...
    <div class="document-list">
      <div class="document-list-button">
        ...
        <el-button class="document-list-button-more" @click="SelectMore"
          >选择多项</el-button
        >
        <el-button class="document-list-button-add" @click="OpenAddDocument"
          >新增文档</el-button
        >
        <el-button class="document-list-button-del" @click="DelectDocument"
          >删除</el-button
        >
      </div>
      <div class="document-list-content">
        ...
        <template v-if="isNormal">
          ...
          <div class="document-list-content-tab">
            <div
              class="document-list-content-tab-item"
              v-for="(item, index) in DocMsg"
              :key="index"
            >
              <span>{{ index + 1 }}</span>
      ...
      <div class="document-add" v-if="IsAddDocument">
        <div class="document-add-box">
          ...
          <div class="document-add-box-footer">
            <button type="button" @click="CloseAddDocument">取消</button>
            <button type="button" @click="SubmitAddMsg">确认</button>
          </div>
        </div>
      </div>
      <!-- 是否显示编辑页面 -->
        ...
        <div class="document-add-box">
          ...
          <div class="document-add-box-body">
            <div>
              文档路径：<input
                type="text"
                v-model="EditDictionaryMsg.docPath"
              />
            </div>
            <div>
          ...
          <div class="document-add-box-footer">
            <button type="button" @click="CloseEditDocument">取消</button>
            <button type="button" @click="SubmitEditDocument">确认</button>
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    async SubmitAddMsg() {
      ...
      if (result.resultCode !== '200')
        return this.$message.error('添加错误,请重新输入')
