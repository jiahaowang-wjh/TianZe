  ...
  <div class="formula">
    ...
    <div class="formula-list">
      <div class="formula-list-search">
        ...
        <button>搜索</button>
        <button type="button" @click="OpenAdd">新增公式</button>
      </div>
      <div class="formula-list-content">
        ...
        <template>
          ...
          <div class="formula-list-content-tab">
            <div
              class="formula-list-content-tab-item"
              v-for="(item, index) in FormulaMsg"
              :key="index"
            >
              <span>{{ index + 1 }}</span>
              ...
              <span>
                <button type="button" @click="OpenEdit(index)">编辑</button>
                <button type="button" @click="OpenDel(index)">删除</button>
              </span>
            </div>
          </div>
        </template>
    ...
    <div class="formula-add" v-if="IsAddFormula">
      <div class="formula-add-box">
        ...
        <div class="formula-add-box-body">
          ...
          <div>公式：<input type="text" v-model="AddFomulaMsg.exp" /></div>
          <div>参数：<input type="text" v-model="AddFomulaMsg.paramter" /></div>
        </div>
        <div class="formula-add-box-footer">
          <button type="button" @click="CloseAdd">取消</button>
          <button type="button" @click="SubmitAddFomula">确认</button>
        </div>
      </div>
    </div>
    <!-- 是否显示编辑页面 -->
    <div class="formula-add" v-if="IsEditFormula">
      <div class="formula-add-box">
        ...
        <div class="formula-add-box-body">
          ...
          <div>公式：<input type="text" v-model="EditFomulaMsg.exp" /></div>
          <div>
        ...
        <div class="formula-add-box-footer">
          ...
          <button type="button" @click="SubmitEditFomula">确认</button>
        </div>
      </div>
    </div>
  </div>
